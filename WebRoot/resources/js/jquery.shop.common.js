...
jQuery(document).ready(function(){
  ...
  jQuery("a[dialog_uri],input[dialog_uri],dt[dialog_uri]").live("click",function(e){
	...
	jQuery("#"+dialog_id).remove();
	 if(dialog_uri!="undefined"){
       jQuery("body").append("<div id='"+dialog_id+"'><div class='white_content'> <a href='javascript:void(0);' dialog_uri='undefined' class='white_close' style='color:#ffffff;' onclick='javascript:jQuery(\"#"+dialog_id+"\").remove();'>X</a><div class='white_box'><h1>"+dialog_title+"</h1><div class='content_load'></div></div></div><div class='black_overlay'></div></div>");
	   e.preventDefault(); 
  ...
  jQuery("a[ck_dialog_uri],input[ck_dialog_uri],dt[ck_dialog_uri]").live("click",function(e){
	  ...
	  if(mulitId!=""){ 
        jQuery("body").append("<div id='"+dialog_id+"'><div class='white_content'> <a href='javascript:void(0);' style='color:#ffffff;' class='white_close' onclick='javascript:jQuery(\"#"+dialog_id+"\").remove();'>X</a><div class='white_box'><h1>"+dialog_title+"</h1><div class='content_load'></div></div></div><div class='black_overlay'></div></div>");
	   e.preventDefault(); 
	   if(dialog_top==undefined||dialog_top==""){
