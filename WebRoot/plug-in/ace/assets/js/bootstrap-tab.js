...
//        mainHeight = 1860;//Ace 右侧高度默认
        ...
        if (options.content) {
            ...
            content = '<div role="tabpanel" class="tab-pane" id="' + id + '"><iframe src="' + options.url + '" width="100%" height="' + mainHeight +
                    '" frameborder="no" border="0" id="test'+id+'" onload="reinitIframe(\'test'+ id +'\')" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"></iframe></div>';
        }
        //加入TABS
...
function reinitIframe(testid){
	var iframe = document.getElementById(testid);
	try{
