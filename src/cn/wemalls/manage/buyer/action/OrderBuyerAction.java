...
//        String wemalls_view_type = CookitTools.Get_View_Type(request);
        ...
        if((wemalls_view_type != null) && (!wemalls_view_type.equals("")) && (wemalls_view_type.equals("android"))){
            mv = new JModelAndView("android/buyer_order.html",
                                   this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 1, request, response);
        }
        if((wemalls_view_type != null) && (!wemalls_view_type.equals("")) && (wemalls_view_type.equals("ios"))){
            mv = new JModelAndView("ios/buyer_order.html",
                                   this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 1, request, response);
        }
...
//                              new SysMap("order_status", Integer.valueOf(20)), "=");
                ofqo.addStringQuery(" and ( obj.order_status=20 or obj.order_status=16 ) ");
            }
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "买家订单列表", value = "/buyer/order.htm*", rtype = "buyer", rname = "用户中心", rcode = "user_center", rgroup = "用户中心")
    @RequestMapping({"/wxapplet/buyer/order.htm"})
    public void wxAppletOrder(HttpServletRequest request, HttpServletResponse response, String currentPage, String order_id, String beginTime, String endTime, String order_status){
    	Map resMap=new HashMap();
        OrderFormQueryObject ofqo = new OrderFormQueryObject(currentPage, resMap, "addTime", "desc");
        ofqo.addQuery("obj.user.id", new SysMap("user_id", SecurityUserHolder.getCurrentUser().getId()), "=");
        if (!CommUtil.null2String(order_id).equals("")){
            ofqo.addQuery("obj.order_id", new SysMap("order_id", "%" + order_id + "%"), "like");
//            resMap.put("order_id", order_id);
        }
        if (!CommUtil.null2String(beginTime).equals("")){
            ofqo.addQuery("obj.addTime", new SysMap("beginTime", CommUtil.formatDate(beginTime)), ">=");
...
//        resMap.put("order_status", order_status);
        IPageList pList = this.orderFormService.list(ofqo);
        
        resMap.put("objsList", pList.getResult());
//        CommUtil.saveIPageList2ModelAndView("", "", "", pList, mv);
        String[] propertys={"objsList","OrderForm","gcs","goods","goods_main_photo"};
...
//        String wemalls_view_type = CookitTools.Get_View_Type(request);
        ...
        if((wemalls_view_type != null) && (!wemalls_view_type.equals("")) && (wemalls_view_type.equals("android"))){
            mv = new JModelAndView("android/buyer_order_cancel.html",
                                   this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 1, request, response);
        }
        if((wemalls_view_type != null) && (!wemalls_view_type.equals("")) && (wemalls_view_type.equals("ios"))){
            mv = new JModelAndView("ios/buyer_order_cancel.html",
                                   this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 1, request, response);
        }
...
//        String wemalls_view_type = CookitTools.Get_View_Type(request);
        ...
        for (int i = 0; i < cookies.length; i++) {
         if (cookies[i].getName().equals("wemalls_view_type")) {
        	 wemalls_view_type=cookies[i].getValue();
         }
        }
        if((wemalls_view_type != null) && (!wemalls_view_type.equals("")) && (wemalls_view_type.equals("wap"))){
        ...
        if((wemalls_view_type != null) && (!wemalls_view_type.equals("")) && (wemalls_view_type.equals("android"))){
            mv = new JModelAndView("android/buyer_order_cofirm.html",
                                   this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request, response);
        }
        if((wemalls_view_type != null) && (!wemalls_view_type.equals("")) && (wemalls_view_type.equals("ios"))){
            mv = new JModelAndView("ios/buyer_order_cofirm.html",
                                   this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request, response);
        }
        OrderForm obj = this.orderFormService.getObjById(CommUtil.null2Long(id));
     ...
     */
    @SecurityMapping(display = false, rsequence = 0, title = "服务中心", value = "/buyer/service_center.htm*", rtype = "buyer", rname = "服务中心", rcode = "user_center", rgroup = "服务中心")
    @RequestMapping({ "/buyer/purse_center.htm" })
    public ModelAndView purse_center(HttpServletRequest request, HttpServletResponse response){
        ModelAndView mv = new JModelAndView("wap/purse_center.html",
                                            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 1, request, response);
     ...
     */
    @SecurityMapping(display = false, rsequence = 0, title = "服务中心", value = "/buyer/service_center.htm*", rtype = "buyer", rname = "服务中心", rcode = "user_center", rgroup = "服务中心")
    @RequestMapping({ "/buyer/about_center.htm" })
    public ModelAndView about_center(HttpServletRequest request, HttpServletResponse response){
        ModelAndView mv = new JModelAndView("wap/about_center.html",
                                            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 1, request, response);
     ...
     */
    @SecurityMapping(display = false, rsequence = 0, title = "服务中心", value = "/buyer/service_center.htm*", rtype = "buyer", rname = "服务中心", rcode = "user_center", rgroup = "服务中心")
    @RequestMapping({ "/buyer/about_detail.htm" })
    public ModelAndView about_detail(HttpServletRequest request, HttpServletResponse response){
        ModelAndView mv = new JModelAndView("wap/about_detail.html",
                                            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 1, request, response);
     ...
     * @return
     */
    @SecurityMapping(display = false, rsequence = 0, title = "服务中心", value = "/buyer/customer_service.htm*", rtype = "buyer", rname = "服务中心", rcode = "user_center", rgroup = "服务中心")
    @RequestMapping({ "/buyer/customer_service.htm" })
    public ModelAndView customer_service(HttpServletRequest request, HttpServletResponse response){
        ModelAndView mv = new JModelAndView("wap/customer_service.html",
                                            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 1, request, response);
