...
import cn.wemalls.foundation.domain.query.PredepositQueryObject;
...
public class PredepositBuyerAction {
    ...
    public ModelAndView predeposit(HttpServletRequest request, HttpServletResponse response, String id){
        ...
        mv.addObject("viewtype",wemalls_view_type);
        if (this.configService.getSysConfig().isDeposit()){
            ...
            List payments = this.paymentService
                            .query(
                                "select obj from Payment obj where obj.type=:type and obj.install=:install and obj.mark !=:mark and obj.mark !=:mark2 and obj.recharge_able='true'",
                                params, -1, -1);
