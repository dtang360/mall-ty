 ...
 */
@Controller
public class PickOrderSellerAction {
    @Autowired
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺订单列表", value = "/seller/pick_order.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order.htm"})
    public ModelAndView pick_order(HttpServletRequest request, HttpServletResponse response, String currentPage, String order_status, String order_id, String beginTime, String endTime, String buyer_userName){
        ModelAndView mv = mv = new JModelAndView(
            "user/default/usercenter/pick_seller_order.html",
            this.configService.getSysConfig(),
            this.userConfigService.getUserConfig(), 0, request, response);
        OrderFormQueryObject ofqo = new OrderFormQueryObject(currentPage, mv,
                "addTime", "desc");
        ofqo.addQuery("obj.pick_store",
                      new SysMap("pick_store",
                                 SecurityUserHolder.getCurrentUser().getStore().getId().toString()), "=");
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺订单详情", value = "/seller/order_view.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_view.htm"})
    public ModelAndView pick_order_view(HttpServletRequest request, HttpServletResponse response, String id){
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺取消订单", value = "/seller/order_cancel.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_cancel.htm"})
    public ModelAndView pick_order_cancel(HttpServletRequest request, HttpServletResponse response, String id, String currentPage){
        ModelAndView mv = new JModelAndView(
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺取消订单保存", value = "/seller/order_cancel_save.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_cancel_save.htm"})
    public String pick_order_cancel_save(HttpServletRequest request, HttpServletResponse response, String id, String currentPage, String state_info, String other_state_info) throws Exception {
        OrderForm obj = this.orderFormService
                        .getObjById(CommUtil.null2Long(id));
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺调整订单费用", value = "/seller/order_fee.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_fee.htm"})
    public ModelAndView pick_order_fee(HttpServletRequest request, HttpServletResponse response, String id, String currentPage){
        ModelAndView mv = new JModelAndView(
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺调整订单费用保存", value = "/seller/order_fee_save.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_fee_save.htm"})
    public String pick_order_fee_save(HttpServletRequest request, HttpServletResponse response, String id, String currentPage, String goods_amount, String ship_price, String totalPrice) throws Exception {
        OrderForm obj = this.orderFormService
                        .getObjById(CommUtil.null2Long(id));
    ...
    @RequestMapping({"/seller/pick_seller_order_outline.htm"})
    public ModelAndView pick_seller_order_outline(HttpServletRequest request, HttpServletResponse response, String id, String currentPage){
        ModelAndView mv = new JModelAndView(
    ...
    @RequestMapping({"/seller/pick_seller_order_outline_save.htm"})
    public String pick_seller_order_outline_save(HttpServletRequest request, HttpServletResponse response, String id, String currentPage, String state_info) throws Exception {
        OrderForm obj = this.orderFormService
                        .getObjById(CommUtil.null2Long(id));
                ...
                if (inventory_type.equals("all")){
                    ...
                    for (Iterator localIterator4 = list.iterator(); localIterator4.hasNext();){
                        ...
                        if (Arrays.equals(temp_ids, gsp_list)){
                            temp.put(
                                "count",
                                Float.valueOf(((Float)temp.get("count")) -
                                                gc.getCount()));
                        }
                    }
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺确认发货", value = "/seller/order_shipping.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_shipping.htm"})
    public ModelAndView pick_order_shipping(HttpServletRequest request, HttpServletResponse response, String id, String currentPage){
        ModelAndView mv = new JModelAndView(
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺确认发货保存", value = "/seller/order_shipping_save.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_shipping_save.htm"})
    public String pick_order_shipping_save(HttpServletRequest request, HttpServletResponse response, String id, String currentPage, String shipCode, String state_info, String order_seller_intro, String ec_id) throws Exception {
        OrderForm obj = this.orderFormService
                        .getObjById(CommUtil.null2Long(id));
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺修改物流", value = "/seller/order_shipping_code.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_shipping_code.htm"})
    public ModelAndView pick_order_shipping_code(HttpServletRequest request, HttpServletResponse response, String id, String currentPage){
        ModelAndView mv = new JModelAndView(
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺修改物流保存", value = "/seller/order_shipping_code_save.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_shipping_code_save.htm"})
    public String pick_order_shipping_code_save(HttpServletRequest request, HttpServletResponse response, String id, String currentPage, String shipCode, String state_info){
        OrderForm obj = this.orderFormService
                        .getObjById(CommUtil.null2Long(id));
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺退款", value = "/seller/order_refund.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_refund.htm"})
    public ModelAndView pick_order_refund(HttpServletRequest request, HttpServletResponse response, String id, String currentPage){
        ModelAndView mv = new JModelAndView(
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺退款保存", value = "/seller/order_refund_save.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_refund_save.htm"})
    public String pick_order_refund_save(HttpServletRequest request, HttpServletResponse response, String id, String currentPage, String refund, String refund_log, String refund_type){
        OrderForm obj = this.orderFormService
                        .getObjById(CommUtil.null2Long(id));
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺退货", value = "/seller/order_return.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_return.htm"})
    public ModelAndView pick_order_return(HttpServletRequest request, HttpServletResponse response, String id, String currentPage){
        ModelAndView mv = new JModelAndView(
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺退货保存", value = "/seller/order_return_save.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_return_save.htm"})
    public String pick_order_return_save(HttpServletRequest request, HttpServletResponse response, String id, String return_info, String currentPage){
        OrderForm obj = this.orderFormService
                        .getObjById(CommUtil.null2Long(id));
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺评价", value = "/seller/order_evaluate.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_evaluate.htm"})
    public ModelAndView pick_order_evaluate(HttpServletRequest request, HttpServletResponse response, String id, String currentPage){
        ModelAndView mv = new JModelAndView(
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺评价保存", value = "/seller/order_evaluate_save.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_evaluate_save.htm"})
    public ModelAndView pick_order_evaluate_save(HttpServletRequest request, HttpServletResponse response, String id, String evaluate_info, String evaluate_seller_val){
        OrderForm obj = this.orderFormService
                        .getObjById(CommUtil.null2Long(id));
    ...
    @RequestMapping({"/seller/pick_order_print.htm"})
    public ModelAndView pick_order_print(HttpServletRequest request, HttpServletResponse response, String id){
        ModelAndView mv = new JModelAndView(
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺物流详情", value = "/seller/ship_view.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_ship_view.htm"})
    public ModelAndView pick_order_ship_view(HttpServletRequest request, HttpServletResponse response, String id){
        ModelAndView mv = new JModelAndView(
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺物流详情", value = "/seller/order_query_userinfor.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_order_query_userinfor.htm"})
    public ModelAndView pick_seller_query_userinfor(HttpServletRequest request, HttpServletResponse response, String id){
        ModelAndView mv = new JModelAndView(
    ...
    @RequestMapping({"/seller/pick_seller_order_return_apply_view.htm"})
    public ModelAndView pick_seller_order_return_apply_view(HttpServletRequest request, HttpServletResponse response, String id, String currentPage){
        ModelAndView mv = new JModelAndView(
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺保存退货申请", value = "/seller/seller_order_return.htm*", rtype = "seller", rname = "订单管理", rcode = "order_seller", rgroup = "交易管理")
    @RequestMapping({"/seller/pick_seller_order_return.htm"})
    public String pick_seller_order_return(HttpServletRequest request, HttpServletResponse response, String id, String gr_id, String currentPage, String mark) throws Exception {
        OrderForm obj = this.orderFormService
                        .getObjById(CommUtil.null2Long(id));
        if (mark.equals("true")){
            if (obj.getStore()
    ...
    @RequestMapping({"/seller/pick_seller_order_return_confirm.htm"})
    public ModelAndView pick_seller_order_return_confirm(HttpServletRequest request, HttpServletResponse response, String id){
    ...
    @RequestMapping({"/seller/pick_seller_order_return_ship_view.htm"})
    public ModelAndView pick_seller_order_return_ship_view(HttpServletRequest request, HttpServletResponse response, String id){
        ModelAndView mv = new JModelAndView("error.html",
                                            this.configService.getSysConfig(),
                                            this.userConfigService.getUserConfig(), 1, request, response);
        OrderForm obj = this.orderFormService
