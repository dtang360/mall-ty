...
import cn.wemalls.foundation.domain.query.AlbumQueryObject;
import cn.wemalls.foundation.service.*;
import cn.wemalls.view.web.tools.AlbumViewTools;
        ...
        for (String id : ids){
            if (!id.equals("")){
                ...
                for (Accessory acc : accs){
                    ...
                    this.databaseTools
                    .execute("update wemalls_album set album_cover_id=null where album_cover_id=" +
                             acc.getId());
                }
