    ...
    public ModelAndView taobao_import_csv(HttpServletRequest request, HttpServletResponse response, String gc_id3, String ugc_ids){
        ...
        try {
            ...
            if (!map.get("fileName").equals("")){
                ...
                int goods_price_pos = 7;// 宝贝价格
                int goods_count_pos = 9;// 宝贝数量
                int goods_status_pos = 17;// 放入仓库
                int goods_transfee_pos = 11;// 运费承担
                int goods_recommend_pos = 18;// 橱窗推荐
                int goods_detail_pos = 20;// 宝贝描述
