...
import cn.wemalls.manage.seller.tools.MenuTools;
import cn.wemalls.view.web.tools.AreaViewTools;
import cn.wemalls.view.web.tools.OrderViewTools;
...
public class BaseSellerAction {
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺中心", value = "/seller/index.htm*", rtype = "buyer", rname = "店铺中心", rcode = "user_center", rgroup = "用户中心")
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺中心导航", value = "/seller/nav.htm*", rtype = "buyer", rname = "店铺中心导航", rcode = "user_center", rgroup = "用户中心")
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺中心导航", value = "/seller/head.htm*", rtype = "buyer", rname = "店铺中心导航", rcode = "user_center", rgroup = "用户中心")
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺中心快捷功能设置", value = "/seller/store_quick_menu.htm*", rtype = "seller", rname = "用户中心", rcode = "user_center_seller", rgroup = "用户中心")
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "店铺中心快捷功能设置保存", value = "/seller/store_quick_menu_save.htm*", rtype = "seller", rname = "用户中心", rcode = "user_center_seller", rgroup = "用户中心")
