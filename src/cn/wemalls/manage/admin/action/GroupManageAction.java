...
import cn.wemalls.foundation.domain.Group;
import cn.wemalls.foundation.domain.GroupGoods;
import cn.wemalls.foundation.domain.query.GroupGoodsQueryObject;
import cn.wemalls.foundation.domain.query.GroupQueryObject;
...
public class GroupManageAction {
    ...
    public ModelAndView group_save(HttpServletRequest request, HttpServletResponse response, String id, String currentPage, String cmd, String begin_hour, String end_hour, String join_hour){
        ...
        if (beginTime.after(new Date())){
            group.setStatus(1);
        }else if (beginTime.before(new Date())){
            group.setStatus(-1);
        }
        if (id.equals(""))
