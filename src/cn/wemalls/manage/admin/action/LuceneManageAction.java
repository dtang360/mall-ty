...
import cn.wemalls.lucene.LuceneThread;
...
public class LuceneManageAction {
    ...
    public ModelAndView lucene(HttpServletRequest request, HttpServletResponse response){
        ...
        String path = (new StringBuilder(String.valueOf(System.getProperty("wemalls_business_edition.root")))).append("lucene").toString();
    ...
    public void lucene_update(HttpServletRequest request, HttpServletResponse response, String id, String hotSearch){
        ...
        String store_lucene_path = (new StringBuilder(String.valueOf(System.getProperty("wemalls_business_edition.root")))).append(File.separator).append("lucene").append(File.separator).append("store").toString();
