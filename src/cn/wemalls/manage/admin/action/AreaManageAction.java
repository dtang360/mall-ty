...
import cn.wemalls.foundation.domain.query.AreaQueryObject;
...
public class AreaManageAction {
    ...
    public ModelAndView area_import(HttpServletRequest request, HttpServletResponse response, String list_url) throws Exception {
        ...
        this.databaseTools.execute("update wemalls_store set area_id=null");

        this.databaseTools.execute("update wemalls_address set area_id=null");

        this.databaseTools.execute("update wemalls_area set parent_id=null");

        this.databaseTools.execute("delete from wemalls_area");
    ...
    public ModelAndView area_export(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String tables = "wemalls_accessory,wemalls_adv_pos,wemalls_advert,wemalls_articleclass,wemalls_article,wemalls_document,wemalls_navigation,wemalls_template,wemalls_sysconfig";
