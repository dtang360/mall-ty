...
public class LuceneUtil {
    ...
    private Document builderDocument(LuceneVo luceneVo){
        ...
        Field goods_salenum = new Field("goods_salenum", CommUtil.null2String(Float.valueOf(luceneVo.getVo_goods_salenum())), Field.Store.YES, Field.Index.ANALYZED);
        document.add(id);
        document.add(title);
