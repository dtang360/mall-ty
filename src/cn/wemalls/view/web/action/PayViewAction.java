...
import cn.wemalls.pay.alipay.util.AlipayNotify;
import cn.wemalls.pay.bill.util.MD5Util;
import cn.wemalls.pay.tenpay.RequestHandler;
import cn.wemalls.pay.tenpay.ResponseHandler;
import cn.wemalls.pay.tenpay.util.TenpayUtil;
            ...
            if (inventory_type.equals("all")){
                ...
                for (Iterator localIterator4 = list.iterator(); localIterator4.hasNext();){
                    ...
                    if (Arrays.equals(temp_ids, gsp_list)){
                        temp.put("count",
                                 Float.valueOf(CommUtil.null2Int(temp.get("count")) -
                                                 gc.getCount()));
                    }
                }
