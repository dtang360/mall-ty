...
public class StoreViewAction {
    ...
    public ModelAndView store_nav(HttpServletRequest request, HttpServletResponse response){
        ...
        if (store.getStore_status() == 2){
            ...
            params.clear();
            params.put("display", Boolean.valueOf(true));
            List gcs = goodsClassService.query("select obj from GoodsClass obj where obj.parent.id is null and obj.display=:display order by obj.sequence asc", params, 0, 14);
