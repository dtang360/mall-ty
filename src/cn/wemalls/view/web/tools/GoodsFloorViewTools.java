...
public class GoodsFloorViewTools {
    ...
    public Map generic_advm(String web_url, String json){
        ...
        if ((json != null) && (!json.equals(""))){
            ...
            if (CommUtil.null2String(map.get("adv_id")).equals("")){
                ...
                if (img != null){
                    ...
                    advMap.put("href",url);
                    advMap.put("src",web_url + "/" +img.getPath() + "/" + img.getName());
                ...
                template = template + "<a href='" + obj.getAp_acc_url() +
                           ...
                           obj.getAp_acc().getPath() + "/" +
                           obj.getAp_acc().getName() + "' /></a>";
                advMap.put("href",obj.getAp_acc_url());
                advMap.put("src",web_url + "/" +obj.getAp_acc().getPath() + "/" +obj.getAp_acc().getName());
            }
        }
        template = template + "</div>";
