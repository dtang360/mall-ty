...
public class Goods extends IdEntity {
    ...
    //库存
    private float goods_inventory;
    //库存类型
    private String inventory_type;
    private float goods_salenum;
    ...
    //照片
    @ManyToMany
    @JoinTable(name = "wemalls_goods_photo", joinColumns = {
    ...
    // 商品自定义分类
    @ManyToMany
    @JoinTable(name = "wemalls_goods_ugc", joinColumns = {
        @javax.persistence.JoinColumn(name = "goods_id")
    }, inverseJoinColumns = {
    ...
    // 商品规格，SKU
    @ManyToMany
    @JoinTable(name = "wemalls_goods_spec", joinColumns = {
        @javax.persistence.JoinColumn(name = "goods_id")
    }, inverseJoinColumns = {
    ...
    @ManyToMany
    @JoinTable(name = "wemalls_goods_combin")
    ...
    public float getGoods_inventory(){
        return this.goods_inventory;
    }

    public void setGoods_inventory(float goods_inventory){
    ...
    public float getGoods_salenum(){
        return this.goods_salenum;
    }

    public void setGoods_salenum(float goods_salenum){
