...
public class LoginAuthenticationFilter extends AuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request) throws AuthenticationException {
        ...
        String login_auth =request.getParameter("login_auth");
//        String login_auth = request.getParameter("login_auth");
        ...
        session.setAttribute("login_auth", String.valueOf(CommUtil.null2String(request.getParameter("login_auth"))));
        //登录类型
        ...
        if (CommUtil.null2Boolean(request.getParameter("encode"))) {
        	...
        	if(null!=login_auth&&0<login_auth.length()) {
        		if("wx_applet_auth_login".equals(login_auth)) {
        			username +=",wx_applet_auth_login";
        		}
        	}
