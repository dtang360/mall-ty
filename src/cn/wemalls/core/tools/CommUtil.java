...
public class CommUtil{
    ...
    public static String formatShortDate(Date v){
        if (v == null) {
            return null;
        }
    ...
    public static void saveIPageList2Map2(String url, String staticURL, String params, IPageList pList, Map<String, Object> map){
        if (pList != null){
            map.put("totalPage", new Integer(pList.getPages()));
            map.put("pageSize", Integer.valueOf(pList.getPageSize()));
            map.put("rows", new Integer(pList.getRowCount()));
            map.put("currentPage", new Integer(pList.getCurrentPage()));
            map.put("objs", pList.getResult());
        }
    }
