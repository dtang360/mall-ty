package cn.wemalls.core.constant;


public class Globals {
    public static final String DEFAULT_SYSTEM_TITLE = "wemallsV2.2";
    ...
    public static final String DEFAULT_WBESITE_NAME = "wemalls";
    ...
    public static final String DEFAULT_TABLE_SUFFIX = "wemalls_";
    public static final String THIRD_ACCOUNT_LOGIN = "wemalls_thid_login_";
